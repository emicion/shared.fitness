...
class CompetitionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create competition" do
    assert_difference('Competition.count') do
      post competitions_url, params: { competition: { name: @competition.name, owner_id: @competition.owner_id, public: @competition.public, start: @competition.start, stop: @competition.stop } }
    end
  ...
  test "should update competition" do
    patch competition_url(@competition), params: { competition: { name: @competition.name, owner_id: @competition.owner_id, public: @competition.public, start: @competition.start, stop: @competition.stop } }
