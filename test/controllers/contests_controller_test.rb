...
class ContestsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create contest" do
    assert_difference('Contest.count') do
      post contests_url, params: { contest: { end_date: @contest.end_date, name: @contest.name, start_date: @contest.start_date, user_id: @contest.user_id } }
    end
  ...
  test "should update contest" do
    patch contest_url(@contest), params: { contest: { end_date: @contest.end_date, name: @contest.name, start_date: @contest.start_date, user_id: @contest.user_id } }
